"""
Helper functions for tweet preprocessing used in ideology detection
...
def is_quote(tweet: str) -> bool:
    # return true if tweet contains QT
    return "QT" in tweet
...
def preprocess_tweet_for_lda(
    ...
    Good for LDA topic modeling, TF-IDF, and similar text analysis.
    ...
    # Remove flag emojis. This is a hacky way to avoid problems with TweetTokenizer.
